...
interface Step15FinalWeightsProps {
  data: number[][];
}

const Step15FinalWeights: React.FC<Step15FinalWeightsProps> = ({ data }) => {
  ...
  return (
    <Box sx={{ my: 4 }}>
      <Typography variant="h6" sx={{ color: '#b4befe', fontWeight: 700, mb: 2 }}>
        Step 15: Weighted Aggregated Averaged Normalization
      </Typography>
      <TableContainer
        component={Paper}
        sx={{
...
export default Step15FinalWeights; 
